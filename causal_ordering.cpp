    ...
    while (recvfrom(m_sock, buffer2, sizeof(buffer2), 0, (struct sockaddr *)&m_r_addr, &addr) >= 0)
    {
        ...
        if (pId == 1)
        {
            ...
            if (vector_first[0] == 2)
            {
                ...
                /*************************************************************/
                if ((delivered_msg[1] + 1 == vector_first[2]) && (delivered_msg[0] >= vector_first[1] && delivered_msg[2] >= vector_first[3]))
                {
            ...
            else if (vector_first[0] == 3)
            {
                ...
                /*************************************************************/
                if ((delivered_msg[2] + 1 == vector_first[3]) && (delivered_msg[0] >= vector_first[1] && delivered_msg[1] >= vector_first[2]))
                {
        ...
        else if (pId == 2)
        {
            ...
            if (vector_first[0] == 1)
            {
                ...
                /*************************************************************/
                if (delivered_msg[0] + 1 == vector_first[1] && (delivered_msg[1] >= vector_first[2] && delivered_msg[2] >= vector_first[3]))
                {
